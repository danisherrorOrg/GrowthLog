  ...
  return (
    <div>
      ...
      {lsModal && (<div className="modal-overlay" onClick={e => e.target === e.currentTarget && setLsModal(false)}><div className="modal" style={{ maxWidth: 500 }}>
        ...
        <div className="form-group"><label className="form-label">The Principle</label><input className="form-input" value={lsForm.principle} onChange={e => setLsForm({ ...lsForm, principle: e.target.value })} placeholder="State the truth clearly…" /></div>
        <div className="form-group"><label className="form-label">Context / Backstory (optional)</label><textarea className="form-textarea" value={lsForm.context} onChange={e => setLsForm({ ...lsForm, context: e.target.value })} placeholder="How did you learn this hard truth?" style={{ minHeight: 90 }} /></div>
        <div className="grid-2" style={{ gap: 12 }}>
          <div className="form-group" style={{ marginBottom: 0 }}><label className="form-label">Date Learned</label><input type="date" className="form-input" value={lsForm.date_learned} onChange={e => setLsForm({ ...lsForm, date_learned: e.target.value })} /></div>
          <div className="form-group" style={{ marginBottom: 0 }}><label className="form-label">Category</label><input className="form-input" value={lsForm.category} onChange={e => setLsForm({ ...lsForm, category: e.target.value })} placeholder="Career / Money / Love…" /></div>
        </div>
      ...
      {faModal && (<div className="modal-overlay" onClick={e => e.target === e.currentTarget && setFaModal(false)}><div className="modal" style={{ maxWidth: 520 }}>
        ...
        <div className="form-group"><label className="form-label">The Message</label><textarea className="form-textarea" value={faForm.content} onChange={e => setFaForm({ ...faForm, content: e.target.value })} placeholder="Write your letter, warning, or reminder…" style={{ minHeight: 120 }} /><div style={{ fontSize: 11, color: 'rgba(13,13,13,0.4)', marginTop: 4 }}>Markdown supported</div></div>
        <div className="grid-2" style={{ gap: 12 }}>
          <div className="form-group" style={{ marginBottom: 0 }}><label className="form-label">Target Reading Age (optional)</label><input type="number" className="form-input" value={faForm.target_age} onChange={e => setFaForm({ ...faForm, target_age: e.target.value })} placeholder="e.g. 50" /></div>
          <div className="form-group" style={{ marginBottom: 0 }}><label className="form-label">Or Target Date (optional)</label><input type="date" className="form-input" value={faForm.target_read_date} onChange={e => setFaForm({ ...faForm, target_read_date: e.target.value })} /></div>
        </div>
      ...
      {paModal && (<div className="modal-overlay" onClick={e => e.target === e.currentTarget && setPaModal(false)}><div className="modal" style={{ maxWidth: 520 }}>
        ...
        <div className="form-group"><label className="form-label">From what age? (optional)</label><input type="number" className="form-input" style={{ width: 100 }} value={paForm.from_age} onChange={e => setPaForm({ ...paForm, from_age: e.target.value })} placeholder="e.g. 21" /></div>
        <div className="form-group"><label className="form-label">What would they say to you now?</label><textarea className="form-textarea" value={paForm.content} onChange={e => setPaForm({ ...paForm, content: e.target.value })} placeholder="What did you want back then? Are you honoring them?" style={{ minHeight: 100 }} /></div>
        <div className="form-group"><label className="form-label">How are you applying it today? (optional)</label><textarea className="form-textarea" value={paForm.applied} onChange={e => setPaForm({ ...paForm, applied: e.target.value })} placeholder="Integrating their wisdom into my reality by…" style={{ minHeight: 70 }} /></div>
      ...
      {reModal && (<div className="modal-overlay" onClick={e => e.target === e.currentTarget && setReModal(false)}><div className="modal" style={{ maxWidth: 500 }}>
        ...
        <div className="form-group"><label className="form-label">The Regret</label><textarea className="form-textarea" value={reForm.text} onChange={e => setReForm({ ...reForm, text: e.target.value })} placeholder="I regret not..." style={{ minHeight: 80 }} /></div>
        <div className="form-group"><label className="form-label">The Strategy</label><textarea className="form-textarea" value={reForm.action_to_avoid} onChange={e => setReForm({ ...reForm, action_to_avoid: e.target.value })} placeholder="What is the precise action you will take to NEVER feel this way again?" style={{ minHeight: 80 }} /></div>
        <div className="form-group"><label className="form-label">Date</label><input type="date" className="form-input" value={reForm.date} onChange={e => setReForm({ ...reForm, date: e.target.value })} style={{ maxWidth: 180 }} /></div>
