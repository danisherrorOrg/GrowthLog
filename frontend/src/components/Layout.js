...
const NAV = [
  ...
  { to: '/todos', icon: '☑', label: 'To-Dos' },
  { to: '/activity', icon: '⏳', label: 'Activity Log' },
  { to: '/thoughts', icon: '🪴', label: 'Mind Garden' },
  { to: '/quotes', icon: '🗝️', label: 'Quote Vault' },
  { to: '/books', icon: '📚', label: 'Library' },
  { to: '/reframes', icon: '🧠', label: 'Reframing' },
