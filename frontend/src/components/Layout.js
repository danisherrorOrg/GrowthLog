...
const NAV = [
  ...
  { to: '/activity', icon: '⏳', label: 'Activity Log', shortcut: null },
  { to: '/thoughts', icon: '🪴', label: 'Mind Garden', shortcut: 'M' },
  { to: '/insights', icon: '🔬', label: 'Insight Lab', shortcut: null },
  { to: '/growth-hub', icon: '🚀', label: 'Growth Hub', shortcut: null },
  { to: '/life-canvas', icon: '🎨', label: 'Life Canvas', shortcut: null },
  ...
  { to: '/manifestations', icon: '✧', label: 'Manifestations', shortcut: null },
  { to: '/snapshots', icon: '○', label: 'Snapshots', shortcut: 'S' },
  { to: '/categories', icon: '▦', label: 'Categories', shortcut: 'C' },
  { to: '/timeline', icon: '🗓️', label: 'Timeline', shortcut: null },
];
